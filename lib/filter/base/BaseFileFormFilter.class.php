...
abstract class BaseFileFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nb_added_files'          => new sfWidgetFormFilterInput(),
      'nb_modified_files'       => new sfWidgetFormFilterInput(),
      'nb_deleted_files'        => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'nb_added_files'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nb_modified_files'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nb_deleted_files'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'state'                   => 'Text',
      'filename'                => 'Text',
      'nb_added_files'          => 'Number',
      'nb_modified_files'       => 'Number',
