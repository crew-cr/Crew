...
abstract class BaseFileForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nb_added_files'          => new sfWidgetFormInputText(),
      'nb_modified_files'       => new sfWidgetFormInputText(),
      'nb_deleted_files'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'nb_added_files'          => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647, 'required' => false)),
      'nb_modified_files'       => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647, 'required' => false)),
      'nb_deleted_files'        => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647, 'required' => false)),
