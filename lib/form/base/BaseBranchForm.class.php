...
abstract class BaseBranchForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'base_branch_name'      => new sfWidgetFormInputText(),
      'commit_reference'      => new sfWidgetFormInputText(),
      'last_commit'           => new sfWidgetFormInputText(),
      'last_commit_desc'      => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'last_commit'           => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'last_commit_desc'      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
