...
class StatusTableMap extends TableMap {
	...
	{
    $this->addRelation('Branch', 'Branch', RelationMap::ONE_TO_MANY, array('id' => 'status_id', ), 'CASCADE', 'RESTRICT');
    $this->addRelation('File', 'File', RelationMap::ONE_TO_MANY, array('id' => 'status_id', ), 'CASCADE', 'RESTRICT');
	} // buildRelations()
