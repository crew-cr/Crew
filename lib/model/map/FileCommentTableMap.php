...
/**
 * This class defines the structure of the 'file_comment' table.
 *
 *
 *
 ...
 */
class FileCommentTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.FileCommentTableMap';
	...
	{
	  // attributes
		$this->setName('file_comment');
		$this->setPhpName('FileComment');
		$this->setClassname('FileComment');
