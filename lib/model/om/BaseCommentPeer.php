...
abstract class BaseCommentPeer {
	...
	const BRANCH_ID = 'comment.BRANCH_ID';

	/** the column name for the FILE_ID field */
	const FILE_ID = 'comment.FILE_ID';
	...
	protected static $enumValueSets = array(
		self::TYPE => array(
			CommentPeer::TYPE_BRANCH,
			CommentPeer::TYPE_FILE,
			CommentPeer::TYPE_LINE,
		),
	);
	...
	{
	  return CommentPeer::$enumValueSets;
	}
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CommentPeer::BRANCH_ID);
			$criteria->addSelectColumn(CommentPeer::FILE_ID);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with their Branch objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comment objects.
	...
	public static function doSelectJoinBranch(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to $obj2 (Branch)
				$obj2->addComment($obj1);
	...
	/**
	 * Selects a collection of Comment objects pre-filled with their File objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comment objects.
	...
	public static function doSelectJoinFile(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to $obj2 (File)
				$obj2->addComment($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Comment) to the collection in $obj4 (File)
	...
	/**
	 * Selects a collection of Comment objects pre-filled with all related objects except Branch.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Comment objects pre-filled with all related objects except File.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
