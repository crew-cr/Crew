...
abstract class BaseProfile extends BaseObject  implements Persistent
{
	...
	public function setNickname($v)
	{
		...
		if ($this->nickname !== $v) {
			$this->nickname = $v;
			$this->modifiedColumns[] = ProfilePeer::NICKNAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ProfilePeer::NUM_COLUMNS - ProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilePeer::NICKNAME)) $criteria->add(ProfilePeer::NICKNAME, $this->nickname);
