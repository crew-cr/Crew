    ...
    Fracs.Outline = function (canvas, options) {
        ...
        var settings = $.extend({}, defaults, options),
                ...
                if (strokeStyle || fillStyle) {
                    if (fillStyle) {
                        ...
                        if (invert) {
                            ...
                            context.rect(docRect.left, rect.top, docRect.width, rect.height);
                        }
                    ...
                    if (strokeStyle) {
                        ...
                        context.lineWidth = scale ? Math.max(strokeWidth, 0.3 / scale) : strokeWidth;
            ...
            draw = function () {
                ...
                scale = Math.max(width / docRect.width, height / docRect.height);
