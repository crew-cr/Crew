    ...
    <table>
      <?php foreach ($files as $file): ?>
        ...
        <?php if($pathDirOld !== $pathDir && $pathDir !== ".") : ?>
          <tr class="path_directory"><td colspan="6"><?php echo $pathDir;?></td></tr>
        <?php endif;?>
        <tr class="<?php echo $file['ReviewRequest'] === 1 ? 'review_request':'' ?>">
          ...
          <td class="file_name">
            <h3><?php echo link_to(stringUtils::lshorten($filename, 80), 'default/file', array('title' => stringUtils::trimTicketInfos($file['LastChangeCommitDesc']), 'query_string' => 'file='.$file['Id'], 'class' => 'tooltip')) ?></h3>
          </td>
          <td class="view_infos">
