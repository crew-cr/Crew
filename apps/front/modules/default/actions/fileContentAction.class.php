 ...
 */
class fileContentAction extends sfAction
{
  /**
  ...
  public function execute($request)
  {
    ...
    $this->fileContent = GitCommand::getShowFile($this->repository->getGitDir(), $this->file->getLastChangeCommit(), $this->file->getFilename());
